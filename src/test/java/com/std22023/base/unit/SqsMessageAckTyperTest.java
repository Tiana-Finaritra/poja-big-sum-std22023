package com.std22023.base.unit;
...
import com.std22023.base.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.std22023.base.endpoint.event.gen.UuidCreated", payload);
